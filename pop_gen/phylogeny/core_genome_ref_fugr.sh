...
#334314 total positions in core alignment, 53288 SNPs (after SPANDx). This is consistent with the phame paper which found 134062 positions and 40675 SNPs shared in an alignment of E coli Shigella and Salmonella (compared to 2.16M positions ansd 267K SNPs when just comparing E coli and Shigella
