   refdir = fugr_neonectria_phame/refdir  # directory where reference (Complete) files are located
  workdir = fugr_neonectria_phame/workdir # directory where contigs/reads files are located and output is stored
