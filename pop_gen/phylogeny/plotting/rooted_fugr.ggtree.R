...
tree = treeio::read.tree("data/Fugr1_ref/map_against_Fugr_no_core_extract/fugr_root.nwk")
plot(tree)
...
# note all the tips are labeled 1:n and then internal nodes
#180 looks like Nf parent
#147 Nd (note the internal nodes then pass up this branch before passing to the MRCA of Nf/Nc
# so gives N-1 (relative to Nd)
# 146+29 = 175 (MRCA of Nd/Nc|f)+(Nd[n]-1) = 175 
#176 Nc
#
