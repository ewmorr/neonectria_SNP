...
dist.Nf = readRDS("data/Nf/IBD/invariant/sum_tigs_len_corrected.rds")
dist.Nd = readRDS("data/Nd/IBD/invariant/hamming_dist.len_corrected.rds")
dist.Nc = readRDS("data/Nc/IBD/invariant/hamming_dist.len_corrected.rds")
...
sample_metadata.Nc = read.csv("data/sample_metadata/Nc_canton_loc_date.csv")
