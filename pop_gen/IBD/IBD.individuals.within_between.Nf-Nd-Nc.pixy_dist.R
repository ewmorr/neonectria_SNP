...
dist.Nf = readRDS("data/Nf/pixy/contig_all_dif_pop/dxy_dist.rds") 
dist.Nf
class(dist.Nf)

dist.Nd = readRDS("data/Nd/pixy/contig_all_dif_pop/dxy_dist.rds") 
head(dist.Nd)

dist.Nc = readRDS("data/Nc/pixy/contig_all_dif_pop/dxy_dist.rds") 
head(dist.Nc)
...
#convert per bp nucelotide difs from pixy to per Kb  
# i.e.,  * 1000
# 
Nf.Dgen.long$difsPerKb = Nf.Dgen.long$value * 1000
Nd.Dgen.long$difsPerKb = Nd.Dgen.long$value * 1000
Nc.Dgen.long$difsPerKb = Nc.Dgen.long$value * 1000
...
#1  Nf  within 1.5881184 1.5471795 1.6243930
#2  Nd  within 3.8819352 3.7943369 3.9498195
#3  Nc  within 0.3159622 0.3141657 0.3185925
#4  Nf between 1.7955681 1.7919384 1.7991540
#5  Nd between 3.8640801 3.8375941 3.8846674
#6  Nc between 4.8389853 4.5918160 5.0189779

#nf/nd wn
(boot_df[1,3]-boot_df[2,3])/boot_df[2,3]
#-0.5908952

#nf/nc wn
(boot_df[1,3]-boot_df[3,3])/boot_df[3,3]
# 4.026293

#nf/nc bn
(boot_df[4,3]-boot_df[5,3])/boot_df[5,3]
# -0.5353181

#nf/nc bn
(boot_df[4,3]-boot_df[6,3])/boot_df[6,3]
# -0.6289371
...
pdf("figures/pop_gen/IBD/within-between.pixy_dist.include_early.pdf", width = 16, height = 7)
...
p1
pdf("figures/pop_gen/IBD/within-between.pixy_dist.grid.include_early.pdf", width = 7, height = 4)
p1
dev.off()
...
pdf("figures/pop_gen/IBD/within-between.pixy_dist.CIs.include_early.pdf", width = 10, height = 4)
#p1 + p2
...
pdf("figures/pop_gen/IBD/within-between.pixy_dist.CIs.color.include_early.pdf", width = 10, height = 4)
#p1 + p2
grid.arrange(p1,p2,ncol = 2, widths = c(0.7,0.3))
dev.off()
...
pdf("figures/pop_gen/IBD/within-between.pixy_dist.three_panel.pdf", width = 10, height = 4)
